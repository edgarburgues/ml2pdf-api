import { generateTrainingPathLinks } from "../services/trainingPathService.js";
import { createJsonResponse, createErrorResponse } from "../utils/responseUtils.js";

export async function handleTrainingPathUrl(req) {
    try {
        ...
        if (!mainUrl.includes("/training/paths/")) {
            return createErrorResponse("Tipo de URL no soportada", 400);
        }

        const result = await generateTrainingPathLinks(mainUrl);
